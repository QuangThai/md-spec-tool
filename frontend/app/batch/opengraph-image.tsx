  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        >
          <svg width="60" height="60" viewBox="0 0 32 32" fill="none">
            <defs>
              ...
              <linearGradient id="batch-gradient-subtle" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <path
              ...
              stroke="url(#batch-gradient-subtle)"
              strokeWidth="2.8"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
        ...
        >
          Convert multiple spreadsheets and export a single ZIP in one run.
        </div>
