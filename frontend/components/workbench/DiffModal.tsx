        ...
        <LazyMotion features={domAnimation}>
          ...
          >
            <m.div
              ...
              className="bg-black/60 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl max-w-4xl w-full max-h-[80vh] flex flex-col overflow-hidden overscroll-contain"
            >
